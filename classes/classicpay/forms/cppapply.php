...
class cppapply extends \moodleform {
    ...
    protected function definition() {
        ...
        if (isset($result->error)) {
            ...
            if ($iscpp) {
                $str = '<div class="enrol-classicpay-info"><img src="'.$OUTPUT->image_url('i/completion-auto-y').'"/> '
                ...
                $str = '<div class="enrol-classicpay-info"><img src="'.$OUTPUT->image_url('i/completion-auto-n').'"/> '
